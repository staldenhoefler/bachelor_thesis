...
class ResNet18Pretrained(LitBaseModel):
    """
    Ein ResNet-18 mit vortrainiertem Backbone für Bildklassifikation in PyTorch Lightning.
    ...
    Erwartet folgende params im YAML:
      model:
        model_params:
          ...
          head_hidden_size (int, optional): Größe einer versteckten Schicht im Head
    """
    ...
    def forward(self, x):
        """
        Forward-Pass durch ResNet-18 Backbone und neuen Head.
